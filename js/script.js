    ...
    btn.addEventListener("click", function (e) {
      ...
      switch (platform) {
        case "amazon":
          ...
          window.open("https://amazon.in/s?k=" + encodeURIComponent(productTitle + " ClearlyU skincare"), "_blank")
          break
        case "flipkart":
          // Replace with actual Flipkart product URLs
          window.open(
            "https://flipkart.com/search?q=" + encodeURIComponent(productTitle + " ClearlyU skincare"),
            "_blank",
          )
          break
        case "whatsapp":
